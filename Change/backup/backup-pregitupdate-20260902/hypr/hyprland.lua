...
-- This laptop uses F2/F3 for volume (decrease/increase)
...
--Bind Phim basic cho em be:
hl.bind("SUPER + D", hl.dsp.exec_cmd("vesktop"), {description = "[Laucher|Apps] Vesktop"})
hl.bind("SUPER + SHIFT + O", hl.dsp.exec_cmd("/home/wisadel/Applications/osu.AppImage"), {description = "[Laucher|Apps] osu!lazer"})
hl.bind("SUPER + ALT + O", hl.dsp.exec_cmd("osu-wine"), {description = "[Laucher|Apps] osu!stable"})
hl.dsp.exec_cmd("fcitx5 -d")
